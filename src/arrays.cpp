 ...
 */
template<typename T>
void Arrays::sortbmin(std::vector<T>& vec) {
 ...
 */
template<typename T>
void Arrays::sortbmax(std::vector<T>& vec) {
 ...
 * @return Nothing: it replaces the vector's content
 */
void Arrays::sortbcha(std::vector<std::string>& v) {
 ...
 */
template<typename T>
void Arrays::randomize(std::vector<T>& v) {
 ...
 */
template<typename T>
T Arrays::getrandi(const std::vector<T>& vec) {
	// Use a random device as a source of randomness
	std::random_device rd;
 ...
 */
template<typename T>
std::vector<std::vector<T>> Arrays::splitv(const std::vector<T>& vec, size_t parts) {
